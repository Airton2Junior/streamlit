...
#plot streamlit bar chart
st.bar_chart(hist_values)



# Plot data on a map by hour
...
# Use a slider to let the reader choose a range of hour:
st.subheader('Map of all pickups by range of hour')
